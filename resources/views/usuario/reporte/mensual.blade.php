            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2>Calificación mensual de ({{ date('M',strtotime('- 1 month')) }})</h2>
                    </div>
                    <div class="col-12 text-center">
                                ...
                                <div class="row">
                                    ...
                                    <table class="table table-striped table-hover mt-4">
                                        <tbody>
                                          ...
                                          <tr>
                                            <th scope="row">Comentarios del mes</th>
                                          ...
                                          <tr>
                                            <th scope="row">Atención del Personal</th>
                                          ...
                                          <tr>
                                            <th scope="row">Calificación General</th>
                                            <th>{{ $resultado }} <i class="fas fa-star" ></i></th>
                                          </tr>
                                          <tr>
                                            <th scope="row">Personal</th>
                                            <th>{{ $agencia->personal_count }} <i class="fas fa-user" ></i></th>
                                          </tr>
