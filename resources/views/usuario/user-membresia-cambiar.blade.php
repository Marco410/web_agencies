	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-9 col-md-8">
				<h4 class="widget-title">Cambiar membresía @if ($suscripcion->contrato->membresia_id == "3")
					<label class="badge" style="background-color: var(--hover);color:white;" >PLUS <small>{{$suscripcion->contrato->plan}}</small></label>
				@elseif($suscripcion->contrato->membresia_id == "2")
					<label class="badge badge-primary" >BASIC <small>{{$suscripcion->contrato->plan}}</small></label>
				@elseif($suscripcion->contrato->membresia_id == "1")
					<label class="badge badge-secondary" >ZERO</label>
				@endif de <strong>{{ $agencia->nombre }}</strong></h4>
								...
								<div class="col-lg-12">
									<div class="card-body">
										<div class="row">
											...
											@if ($suscripcion->contrato->membresia_id == 2  )
												@if ($_GET['membresia'] != 'Basic' )
											...
											@if($_GET['membresia'] == 'Plus' || $suscripcion->contrato->plan == "mensual"  ||  $suscripcion->contrato->membresia_id == 2 && $suscripcion->contrato->plan != "semestral" )
												<div class="col-sm-12 border-bottom">
													<div class="row mb-2 mt-2">
														<div class="col-sm-7">
															<div class="form-check ">
																<input class="form-check-input" type="radio" name="plan" value="semestral" id="semestral" required  >
											...
											@if($suscripcion->contrato->plan == "mensual" || $suscripcion->contrato->plan == "semestral" ||$suscripcion->contrato->membresia_id == 2)
											<div class="col-sm-12 border-bottom">
												<div class="row">
													<div class="col-sm-7">
														<div class="form-check mt-2 mb-2">
															<input class="form-check-input" required type="radio" name="plan" value="anual" id="anual" checked >
