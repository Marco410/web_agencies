	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-9 col-md-8">
				<h4 class="widget-title">Cambiar Plan @if ($agencia->membresia_id == "3")
				...
				<div class="row">
					...
					@if ($suscripcion->contrato->membresia_id == 2 && $suscripcion->contrato->plan != "anual")
					<div class="col-sm-6 mb-4">
						<div class="card-plan plan">
							...
							<div class="card-body-plan">
								...
								<a style="cursor: pointer" href="{{ route('user.perfil.membresia.cambiar') . '?membresia=Basic&agencia='.$agencia->id }}"  >
					...
					<div class="col-sm-6 mb-4">
						<div class="card-plan plan">
							...
							<div class="card-body-plan">
								...
								<a style="cursor: pointer" href="{{ route('user.perfil.membresia.cambiar') . '?membresia=Plus&agencia='.$agencia->id }}" >
				...
				@else
					<p>No puedes cambiar el contrato, porque no tienes una suscripción activa.</p>
				@endif
