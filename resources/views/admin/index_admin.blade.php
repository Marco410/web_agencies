...
<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-12">
							<h3 class="page-title">Bienvenido  <span class="text-primary" >{{ auth()->user()->name }} {{ auth()->user()->apellido_p }}</span></h3>
						</div>
					</div>
				</div>
				<!-- /Page Header -->
						...
						<div class="card">
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<div class="dash-widget-info">
										<h3>{{ $dealers }}</h3>
										<h6 class="text-muted">Dealers</h6>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<div class="dash-widget-info">
										<h3>{{ $agencias }}</h3>
										<h6 class="text-muted">Agencias</h6>
									</div>
								</div>
							</div>
						</div>
										...
										<tbody>
											<tr>
												<td class="text-nowrap">
													<img class="avatar-xs rounded-circle" src="../assets_admin/img/customer/user-05.jpg" alt="User Image"> Annette Silva
												</td>
											...
											<tr>
												<td class="text-nowrap">
													<img class="avatar-xs rounded-circle" src="../assets_admin/img/customer/user-06.jpg" alt="User Image"> Stephen Wilson</td>
											...
											<tr>
												<td class="text-nowrap">
													<img class="avatar-xs rounded-circle" src="../assets_admin/img/customer/user-07.jpg" alt="User Image"> Ryan Rodriguez</td>
											...
											<tr>
												<td class="text-nowrap">
													<img class="avatar-xs rounded-circle" src="../assets_admin/img/customer/user-08.jpg" alt="User Image"> Lucile Devera
												</td>
											...
											<tr>
												<td class="text-nowrap">
													<img class="avatar-xs rounded-circle" src="../assets_admin/img/customer/user-09.jpg" alt="User Image"> Roland Storey</td>
