            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">Añadir Nueva Agencia</h3>
                            </div>
                        </div>
                    </div>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group form-focus">
											...
											<input type="text" readonly required id="place_id_input"  value="{{ old('place_id') }}"  name="place_id" class="form-control floating" placeholder="Escribe el place ID">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group form-focus">
