            ...
            <div class="container">
                <div class="row">
                    <div class="col-4 text-center offset-4">
                        <img class="img-fluid" src="{{ asset('assets/img/logo-negro.png') }}" alt="Logo AutoNavega">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="col-12 text-center">
                                    <h2> {{ $user->name }} {{ $user->apellido_p }} {{ $user->apellido_m }}</h2>
                                    <h3>Gracias por registrarte en AutoNavega®</h3>
                                    @if ($user->verify == 0)
