                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-12 text-center">
                                    <h2> {{ $solicitud->user->name }} {{ $solicitud->user->apellido_p }} {{ $solicitud->user->apellido_m }} gracias por tu solicitud en AutoNavega®</h2>
                                    <h3>Tu solicitud ya fue revizada. Y la aprobamos.</h3>
                                    <p>Tu nueva agencia se añadió en tu panel de administración.</p>
