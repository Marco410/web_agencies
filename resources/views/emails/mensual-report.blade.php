                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-12 text-center">
                                    <h2>Hola, {{ $user->name }} {{ $user->apellido_p }} {{ $user->apellido_m }}</h2>
                                    <h3>¡Felicidades!</h3>
                                    <h4>Tu reporte mensual esta listo.</h4>
                                    <label for="">Tus agencias:</label>
                                    <ul>
                                        @foreach ($user->agencies as $agencia)
                                        <li>{{ $agencia->agencia[0]->nombre }}</li>
                                        @endforeach
                                    </ul>
                                    <a href="https://autonavega.com/usuario/reportes"><p>Da clic aquí para ir a tu panel de administración y descargar tu reporte.</p></a>
                                </div>
                            </div>
                        </div>
                    </div>
